...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#3B168F]/95 backdrop-blur-[14px]">
      <div className="container flex h-[60px] items-center justify-between gap-4 py-1.5 mx-auto px-4">
        <Link href="/" className="min-w-0 flex items-center gap-2">
          <img
            src="/logo.png"
            alt="Sparkovation Hub Logo"
            className="h-11 w-11 shrink-0 select-none object-contain brightness-[1.2]"
          />
          <div className="min-w-0 leading-none">
            <strong className="font-heading text-base font-bold text-white sm:text-lg block">
              Sparkovation Hub
            </strong>
            <span className="font-mono text-[8px] font-medium uppercase tracking-wider text-white/60 sm:text-[9px] block mt-0.5">
                ...
                <SheetHeader className="border-b border-[var(--color-light-border)] px-6 py-5 text-left bg-[var(--color-pure-white)] shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="leading-none">
                      <SheetTitle className="text-left font-heading font-bold text-xl text-[var(--color-ink-black)] leading-tight">
                        Sparkovation Hub
                      </SheetTitle>
                      <p className="font-mono text-[10px] font-bold uppercase tracking-wider text-[var(--color-muted-gray)] mt-1">
                        of Science & Technology Pvt. Ltd.
                      </p>
                    </div>
                  </div>
